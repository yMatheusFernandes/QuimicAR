...
namespace Unity.Tutorials.Core.Editor
{
    ...
    public class UserSetting<T> : BaseSetting<T>
    {
        ...
        /// <param name="value">The value to initialize this new UserSetting to</param>
    ...
    public class ProjectSetting<T> : BaseSetting<T>
    {
        ...
        /// <param name="name">Use Tr() in order to have localization support.</param>
        /// <param name="value">The value to initialize this new ProjectSetting to</param>
        /// <param name="tooltip">Use Tr() in order to have localization support.</param>
    ...
    public class BaseSetting<T> : UnityEditor.SettingsManagement.UserSetting<T>
    {
        ...
        /// <param name="name">Use Tr() in order to have localization support.</param>
        /// <param name="value">The value to initialize this new BaseSetting to</param>
        /// <param name="scope">The SettingScope defining the scope of that new setting</param>
        /// <param name="tooltip">Use Tr() in order to have localization support.</param>
