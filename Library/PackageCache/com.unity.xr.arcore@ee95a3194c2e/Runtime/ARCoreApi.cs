...
namespace UnityEngine.XR.ARCore
{
    static class Api
    {
        ...
        [DllImport(Constants.k_LibraryName, EntryPoint="UnityARCore_session_setFeatureRequested")]
        public static extern void SetFeatureRequested(Feature feature, bool requested);

        [DllImport(Constants.k_LibraryName, EntryPoint="UnityARCore_session_getRequestedFeatures")]
