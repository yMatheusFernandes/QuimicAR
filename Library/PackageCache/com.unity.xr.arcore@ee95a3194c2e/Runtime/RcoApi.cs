...
namespace UnityEngine.XR.ARCore
{
    internal static class RcoApi
    {
        ...
        [DllImport(Constants.k_LibraryName, EntryPoint="UnityARCore_rco_retain")]
        public static extern int Retain(IntPtr ptr);

        [DllImport(Constants.k_LibraryName, EntryPoint="UnityARCore_rco_release")]
        public static extern int Release(IntPtr ptr);

        [DllImport(Constants.k_LibraryName, EntryPoint="UnityARCore_rco_retain_count")]
